...
<nav class="fixed top-0 w-full z-50 bg-white/80 backdrop-blur-md shadow-[0px_20px_40px_rgba(25,28,30,0.06)] h-20">
  <div class="flex justify-between items-center px-4 md:px-8 h-full max-w-full mx-auto">
    ...
    <div class="flex items-center gap-3 md:gap-12">
      <span class="text-2xl font-black text-teal-900 font-headline tracking-tight">
        EventSpeak
      </span>
    ...
    <div class="flex items-center gap-3 md:gap-4">
      ...
      <div class="relative" id="notifWrapper">
        ...
        {{-- Popup Notifikasi --}}
        <div id="notifPopup"
          class="hidden absolute right-0 top-12 w-80 bg-white rounded-2xl shadow-xl border border-slate-100 z-50 overflow-hidden">

          <div class="px-4 py-3 border-b border-slate-100 flex items-center justify-between">
            <h3 class="font-bold text-slate-800 text-sm">Notifikasi</h3>
            <span class="text-xs text-slate-400">
              {{ count($notifikasi) }} pesan
            </span>
          </div>
          ...
          <div class="max-h-80 overflow-y-auto divide-y divide-slate-50">
            ...
            <div class="flex items-start gap-3 px-4 py-3 hover:bg-slate-50 transition">
              ...
              <span class="material-symbols-outlined {{ $notif->color ?? '' }} text-xl mt-0.5">
      ...
      <a href="{{ route('pengguna.profil') }}"
        class="w-10 h-10 rounded-full bg-primary flex items-center justify-center text-white shadow-md overflow-hidden hover:scale-105 transition-transform">
      ...
      <div class="flex items-center gap-4">
        ...
        <a href="{{ route('pengguna.registrasi') }}"
